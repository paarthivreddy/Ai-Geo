-- PostGIS initialization script for OSM database
-- Run this on osm-postgres container startup
...
-- Admin boundaries table for OSM data
...
CREATE INDEX IF NOT EXISTS idx_osm_osm_id ON osm.admin_boundaries(osm_id);
